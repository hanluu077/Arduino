...
// FOLLOW RIGHT WALL
  ...
  switch (wallState) {
    case AWAY_FROM_WALL:    // Come back to wall, turn right
      Serial.println("turn right");
      turnright();
      break;
    case HEADED_TOWARDS_WALL:    // Turn hard left to get back parallel with the wall
      turnleft();
            Serial.println("turn left");
      break;
    case FOLLOWING_WALL:   // Drive forward
      straight();
      Serial.println("go straight");
      break;
    case AT_CORNER:   // Turn hard left
      turnleft();
